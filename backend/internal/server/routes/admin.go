...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	adminSettings := admin.Group("/settings")
	{
		...
		// 模型广场配置
		adminSettings.GET("/model-marketplace", h.Admin.Setting.GetModelMarketplaceData)
		adminSettings.PUT("/model-marketplace", h.Admin.Setting.UpdateModelMarketplaceData)
	}
}
