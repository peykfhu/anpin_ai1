...
export async function getModelMarketplaceData(): Promise<unknown[]> {
  const { data } = await apiClient.get<unknown[]>('/admin/settings/model-marketplace')
  return data
}

export async function updateModelMarketplaceData(models: unknown[]): Promise<void> {
  await apiClient.put('/admin/settings/model-marketplace', models)
}
...
export const settingsAPI = {
  ...
  resetWebSearchUsage,
  getModelMarketplaceData,
  updateModelMarketplaceData
}
