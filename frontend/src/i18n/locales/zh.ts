export default {
  ...
  admin: {
    ...
    settings: {
      ...
      registration: {
        ...
        referral: '返佣推广系统',
        referralHint: '允许用户通过邀请链接邀请他人注册，并从被邀请人的充值中获得佣金',
        referralCommissionRate: '返佣层级',
        referralCommissionRateHint: '返佣比例根据被邀请人当月累计充值金额自动调整，次月重新计算',
        referralTierBronze: '青铜',
        referralTierBronzeRange: '月充值 < $500',
        referralTierSilver: '白银',
        referralTierSilverRange: '$500 – $3,000',
        referralTierGold: '黄金',
        referralTierGoldRange: '月充值 > $3,000',
        passwordReset: '忘记密码',
      ...
      modelMarketplace: {
        title: '模型广场',
        description: '配置在公开模型广场页面中展示的模型及定价信息',
        addModel: '添加模型',
        modelCount: '已配置 {count} 个模型',
        noModels: '暂无模型配置。添加模型后将显示在模型广场页面。',
        unnamed: '（未命名模型）',
        modelName: '模型名称',
        platform: '平台',
        inputPrice: '输入价格 ($/MTok)',
        outputPrice: '输出价格 ($/MTok)',
        cacheWritePrice: '缓存写入 ($/MTok)',
        cacheReadPrice: '缓存读取 ($/MTok)',
        billingMode: '计费模式',
        rateMultiplier: '倍率',
        tags: '标签',
        tagsPlaceholder: '逗号分隔，如 vision,code,fast',
      },
      site: {
        title: '站点设置',
        description: '自定义站点品牌',
  ...
  referral: {
    ...
    withdrawConfirm: '确认将 {amount} 佣金提现到账户余额？',
    noCommission: '暂无佣金可提现',
    ...
    statusCancelled: '已取消',
    noInvites: '暂无邀请记录',
    noInvitesDesc: '分享您的邀请码，邀请好友加入',
    noCommissions: '暂无佣金记录',
    noCommissionsDesc: '被邀请人充值后将自动产生佣金',
    howItWorks: '推广说明',
    step1Title: '分享邀请码',
    step1Desc: '复制您的专属邀请码或链接，发送给好友',
    step2Title: '好友注册',
    step2Desc: '好友使用您的邀请码完成注册',
    step3Title: '好友充值',
    step3Desc: '好友每次充值，您都能获得相应比例的佣金',
    step4Title: '获得佣金',
    step4Desc: '佣金自动到账，可随时提现到账户余额',
    referralDisabled: '推广返佣功能暂未开启',
    referralDisabledDesc: '请联系管理员了解详情',
    commissionTiers: '返佣层级',
    commissionTiersDesc: '被邀请人月充值越多，您获得的佣金比例越高',
    tierBronze: '青铜',
    tierSilver: '白银',
    tierGold: '黄金',
    tierBronzeCondition: '月充值 < $500',
    tierSilverCondition: '月充值 $500 – $3,000',
    tierGoldCondition: '月充值 > $3,000',
    currentTier: '当前层级',
    monthlyRechargeNote: '返佣比例根据被邀请人当月累计充值金额自动调整，次月重新计算。充值越多，佣金比例越高！',
  },
