export default {
  ...
  admin: {
    ...
    settings: {
      ...
      registration: {
        ...
        referral: 'Referral/Commission System',
        referralHint: 'Allow users to invite others and earn commission from their recharges',
        referralCommissionRate: 'Commission Tiers',
        referralCommissionRateHint: 'Commission rate adjusts automatically based on invitee cumulative monthly recharge, resets each month',
        referralTierBronze: 'Bronze',
        referralTierBronzeRange: 'Monthly < $500',
        referralTierSilver: 'Silver',
        referralTierSilverRange: '$500 – $3,000',
        referralTierGold: 'Gold',
        referralTierGoldRange: 'Monthly > $3,000',
      ...
      modelMarketplace: {
        ...
        description: 'Configure which models and pricing to display on the public Model Plaza page',
        addModel: 'Add Model',
        modelCount: '{count} model(s) configured',
        noModels: 'No models configured. Add models to display them on the Model Plaza page.',
        ...
        rateMultiplier: 'Rate Multiplier',
        tags: 'Tags',
        tagsPlaceholder: 'Comma-separated, e.g. vision,code,fast',
      },
      site: {
        title: 'Site Settings',
  ...
  payment: {
    ...
    recharge: {
      ...
      balance: 'Balance',
      buyNow: 'Buy Now',
      usdSuffix: ' USD Balance Recharge',
    },
  ...
  modelPlaza: {
    ...
    loadError: 'Failed to load model pricing data',
    inputPrice: 'Input',
    outputPrice: 'Output',
    cacheWritePrice: 'Cache Write',
    cacheReadPrice: 'Cache Read',
  ...
  referral: {
    title: 'Referral',
    description: 'Invite friends to register and recharge, earn commission rewards',
    ...
    withdrawConfirm: 'Confirm withdrawing {amount} commission to account balance?',
    noCommission: 'No commission available for withdrawal',
    minWithdraw: 'Minimum withdrawal amount is {amount}',
    inviteRecords: 'Invite Records',
    commissionRecords: 'Commission Details',
    ...
    noInvitesDesc: 'Share your referral code to invite friends',
    noCommissions: 'No commission records',
    noCommissionsDesc: 'Commission will be generated when invitees recharge',
    howItWorks: 'How It Works',
    step1Title: 'Share Code',
    step1Desc: 'Copy your unique referral code or link and share with friends',
    step2Title: 'Friend Registers',
    step2Desc: 'Friend registers using your referral code',
    step3Title: 'Friend Recharges',
    step3Desc: 'You earn a commission for every recharge your friend makes',
    step4Title: 'Earn Commission',
    step4Desc: 'Commission is credited automatically and can be withdrawn anytime',
    referralDisabled: 'Referral system is not enabled',
    referralDisabledDesc: 'Please contact administrator for details',
    commissionTiers: 'Commission Tiers',
    commissionTiersDesc: 'Higher monthly recharge from invitees means higher commission rate for you',
    tierBronze: 'Bronze',
    tierSilver: 'Silver',
    tierGold: 'Gold',
    tierBronzeCondition: 'Monthly recharge < $500',
    tierSilverCondition: 'Monthly recharge $500 – $3,000',
    tierGoldCondition: 'Monthly recharge > $3,000',
    currentTier: 'Current',
    monthlyRechargeNote: 'Commission rate adjusts automatically based on invitee cumulative monthly recharge. Resets each month. More recharge = higher commission!',
  },
